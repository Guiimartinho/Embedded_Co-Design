	...
	; Compiler options:
	;
	; -oDEO SPI PIC (Slave).cof -mDEO SPI PIC (Slave).map --summary=default \
	; --output=default main.p1 Slave_Initilisation.p1 SPI.p1 \
	; Decode_Create_MSG.p1 --chip=16F877A \
	; -IC:\Users\Alex\Dropbox\UWE\UWE Final Year\co-design VHDL\Code\14a - Deo SPI PIC (Slave) \
