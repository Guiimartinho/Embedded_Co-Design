	...
	; Compiler options:
	;
	; -oDEO SPI PIC (Master).cof -mDEO SPI PIC (Master).map \
	; --summary=default --output=default main.p1 SPI.p1 \
	; Master_Initilisation.p1 Read_Create_MSG.p1 --chip=16F877A \
	; -IC:\Users\Alex\Dropbox\UWE\UWE Final Year\co-design VHDL\Code\14b - Deo SPI PIC (Master) \
